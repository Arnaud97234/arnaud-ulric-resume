...
function Home() {
    ...
    return (
        <main className="main" id={styles.main}>
            ...
            <Divider className={styles.divider} style={{ margin: '0 40px' }} orientation='vertical' variant='middle' flexItem />
            <div className={styles.rightContainer}>
                <div className={styles.head}>
                    ...
                    <div className={styles.userPicture}>
                            <Image fill={true} src='/userPicture.jpg' alt='user' priority={true}/>
                    </div>
                </div>
                <div className={styles.box}>
                <Divider className={styles.divider} component="div" textAlign='left' style={{paddingTop: "20px"}}>
                    ...
                    <Divider className={styles.divider} component="div" textAlign='left' style={{paddingTop: "25px", marginTop: "25px"}}>
                    <div style={{ paddingLeft:'10px', paddingRight: '10px', display: 'flex', flexDirection: 'row', alignItems: 'center', margin: '10px 0px' }}>
                            <FontAwesomeIcon icon={faLocationArrow} style={{ marginRight: '15px' }} />
